...
/**
 * @ClassName: KBarManagerUtils
 * @Description:
 * @Author: dingchao
 * @Date: 2018/11/8 15:15
 */
public class KBarManagerUtils {
    ...
    public static void setStatusBarColor(Activity activity, int colorId) {
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.LOLLIPOP) {
            ...
            KBarStatusUtils systemBarTintManager = new KBarStatusUtils(activity);
    ...
    public static void setStatusBar(Activity activity) {
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.KITKAT) {
            final ViewGroup linear_bar = (ViewGroup) activity.findViewById(android.R.id.content);
            if (linear_bar == null)
                return;
    ...
    public static boolean setStatusBarDarkTheme(Activity activity, boolean dark) {
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.KITKAT) {
            ...
            } else if (KBarUtils.isMiui()) {
                setStatusBarFontIconDark(activity, TYPE_MIUI, dark);
            } else if (KBarUtils.isFlyme()) {
