...
public class KPerMaUtil {
    private static final int REQUEST_CODE = 0x0001;
    private HashMap<String, Integer> hashmap;

    private static class Holder {
        public static final KPerMaUtil MANAGER = new KPerMaUtil();
    }
     ...
     * 单例获取对象
     */
    public static KPerMaUtil getInstance(Context context) {
    ...
    /**
     * 是不是需要显示权限请求的关系，可以设置对话框。采用内部类Builder的建造者模式，解耦合方式 * <p> * 这个方法可能不适合同时申请多个权限
     */
