...
public class KActivityUtil {
    ...
    private static KActivityUtil KActivityUtil;

    public static KActivityUtil getInstance() {
        if (KActivityUtil == null)
            KActivityUtil = new KActivityUtil();
        return KActivityUtil;
    }
