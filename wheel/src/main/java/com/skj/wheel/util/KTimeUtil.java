...
public class KTimeUtil {
    ...
    public static Long getYesterdayBegin(int day) {
        ...
        Date date = KTimeUtil.getDate(yesterday, 1);
        return date.getTime();
    }
    ...
    public static List<String> findDates() {
        ...
        try {
            ...
            String start = KTimeUtil.getFormatDate(cal.getTime(), str[4]);
            String end = KTimeUtil.MillisToStr(KTimeUtil.getCurrentTime(), 4);
