...
import com.skj.wheel.definedview.password.CustomPasswordTransformationMethod;
import com.skj.wheel.definedview.password.ImeDelBugFixedEditText;
import com.skj.wheel.definedview.password.PasswordView;
...
public class GridPasswordView extends LinearLayout implements PasswordView {
    ...
    private static final int DEFAULT_CORNERRADIUS = 10;
    ...
    private void initAttrs(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        mLineWidth = (int) ta.getDimension(R.styleable.gridPasswordView_gpvLineWidth, DisplayUtil.dp2px(context, 1));
        ...
        mGridCornerRadius = ta.getInt(R.styleable.gridPasswordView_gpvGridCornerRadius, DEFAULT_CORNERRADIUS);
    ...
    private void inflaterViews(Context context) {
        ...
        inflater.inflate(R.layout.layout_gridpassword_view, this);
    ...
    private GradientDrawable generateBackgroundDrawable() {
        ...
        drawable.setCornerRadius(mGridCornerRadius);
