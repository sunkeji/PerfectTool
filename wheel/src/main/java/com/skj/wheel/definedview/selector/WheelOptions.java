...
public class WheelOptions<T> {
    ...
    public void setPicker(ArrayList<T> options1Items,
        ...
        // 选项2
        wv_option2 = (WheelView) view.findViewById(R.id.wv_option2);
        ...
        // 选项3
        wv_option3 = (WheelView) view.findViewById(R.id.wv_option3);
        if (mOptions3Items != null)
            wv_option3.setAdapter(new ArrayWheelAdapter(mOptions3Items.get(0)
                    .get(0)));// 设置显示数据
        wv_option3.setCurrentItem(wv_option2.getCurrentItem());// 初始化时显示的数据
