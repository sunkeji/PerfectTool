...
import com.skj.wheel.definedview.selector.adapters.WheelAdapter;
import com.skj.wheel.definedview.selector.utils.InertiaTimerTask;
import com.skj.wheel.definedview.selector.utils.LoopViewGestureListener;
import com.skj.wheel.definedview.selector.utils.MessageHandler;
import com.skj.wheel.definedview.selector.utils.OnItemSelectedListener;
import com.skj.wheel.definedview.selector.utils.OnItemSelectedRunnable;
import com.skj.wheel.definedview.selector.utils.SmoothScrollTimerTask;
...
public class WheelView extends View {
     ...
     */
//    private void refitText(String text, Paint paint, int textWidth) {
//        if (textWidth > 0) {
//            paint = new Paint();
...
//            //所有字符串所占像素宽度             int textWidths = rect.width();
//            cTextSize = this.getTextSize();//这个返回的单位为px             while(textWidths > availableWidth){
//            cTextSize = cTextSize - 1;
//            testPaint.setTextSize(cTextSize);//这里传入的单位是px                 textWidths = testPaint.getTextWidths(text, widths);
//        }
