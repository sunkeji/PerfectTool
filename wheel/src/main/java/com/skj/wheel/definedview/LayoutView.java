 ...
 * @modifyTime： 2017/2/21
 * @explain：空页面 错误页面 数据加载中 展示
 */
public class LayoutView extends LinearLayout {
    ...
    private int mLoadingImageViewId;
...
//    private int mLoadingDrawable = R.drawable.ic_loading;
    private int mErrorDrawable = R.mipmap.ic_launcher;
    private int mEmptyDrawable = R.mipmap.ic_launcher;
    private int mLoadingDrawable = R.mipmap.ic_launcher;

    private String mErrorMessage = "加载失败";
    private String mEmptyMessage = "暂无数据";
    private String mLoadingMessage = "加载中···";

    private int mLoadingViewButtonId = R.id.view_loading_btn;
    private int mErrorViewButtonId = R.id.view_error_btn;
    private int mEmptyViewButtonId = R.id.view_empty_btn;
...
//        getChildViews();
    ...
    /**
     * Gets if recyler_divider button is shown in the empty view
     *
     * @return if recyler_divider button is shown in the empty view
     */
    ...
    /**
     * Sets if recyler_divider button will be shown in the empty view
     *
     * @param showEmptyButton will recyler_divider button be shown in the empty view
     */
    ...
    /**
     * Gets if recyler_divider button is shown in the loading view
     *
     * @return if recyler_divider button is shown in the loading view
     */
    ...
    /**
     * Sets if recyler_divider button will be shown in the loading view
     *
     * @param showLoadingButton will recyler_divider button be shown in the loading view
     */
    ...
    /**
     * Gets if recyler_divider button is shown in the error view
     *
     * @return if recyler_divider button is shown in the error view
     */
    ...
    /**
     * Sets if recyler_divider button will be shown in the error view
     *
     * @param showErrorButton will recyler_divider button be shown in the error view
     */
    ...
    private void refreshMessages() {
        ...
        if (mEmptyMessageViewId > 0 && mEmptyMessage != null) {
            ...
            mEmptyImageView = (ImageView) mEmptyView.findViewById(mEmptyImageViewId);
//            if (mEmptyDrawable == 0) {
//                mEmptyImageView.setVisibility(GONE);
//            } else {
//                mEmptyImageView.setVisibility(VISIBLE);
            mEmptyImageView.setImageResource(mEmptyDrawable);
//            }
...
//            setTopDrawables(mLoadingMessageView,mLoadingDrawable);// loading 不能已经有loading image view ，不能直接设置TopDrawable
    ...
    private void setDefaultValues() {
        if (mEmptyView == null) {
            ...
            if (!(mEmptyMessageViewId > 0)) mEmptyMessageViewId = R.id.view_empty_message;
            if (!(mEmptyImageViewId > 0)) mEmptyImageViewId = R.id.view_empty_icon;
        ...
        if (mLoadingView == null) {
            ...
            mLoadingAnimationViewId = R.id.view_loading_icon;
            if (!(mLoadingMessageViewId > 0)) mLoadingMessageViewId = R.id.view_loading_message;
        ...
        if (mErrorView == null) {
            ...
            if (!(mErrorMessageViewId > 0)) mErrorMessageViewId = R.id.view_error_message;
