...
/** 
 * DAO for table "DOWN_APK_INFO".
*/
public class DownApkInfoDao extends AbstractDao<DownApkInfo, Long> {

    public static final String TABLENAME = "DOWN_APK_INFO";

    /**
     * Properties of entity DownApkInfo.<br/>
    ...
    public DownApkInfoDao(DaoConfig config) {
        super(config);
    }
    
    public DownApkInfoDao(DaoConfig config, DaoSession daoSession) {
    ...
    public static void createTable(Database db, boolean ifNotExists) {
        ...
        db.execSQL("CREATE TABLE " + constraint + "\"DOWN_APK_INFO\" (" + //
    ...
    public static void dropTable(Database db, boolean ifExists) {
        String sql = "DROP TABLE " + (ifExists ? "IF EXISTS " : "") + "\"DOWN_APK_INFO\"";
        db.execSQL(sql);
    }

    @Override
    protected final void bindValues(DatabaseStatement stmt, DownApkInfo entity) {
        stmt.clearBindings();
    ...
    @Override
    protected final void bindValues(SQLiteStatement stmt, DownApkInfo entity) {
        stmt.clearBindings();
        stmt.bindLong(1, entity.getId());
    ...
    @Override
    public DownApkInfo readEntity(Cursor cursor, int offset) {
        DownApkInfo entity = new DownApkInfo( //
    ...
    @Override
    public void readEntity(Cursor cursor, DownApkInfo entity, int offset) {
    ...
    @Override
    protected final Long updateKeyAfterInsert(DownApkInfo entity, long rowId) {
        entity.setId(rowId);
        return rowId;
    }
    
    @Override
    public Long getKey(DownApkInfo entity) {
        if(entity != null) {
            return entity.getId();
        } else {
            return null;
    ...
    @Override
    public boolean hasKey(DownApkInfo entity) {
