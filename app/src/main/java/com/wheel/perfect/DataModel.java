...
public class DataModel {
    ...
    public static void initData(ArrayList<ProvinceBean> options1Items, ArrayList<ArrayList<String>> options2Items, ArrayList<ArrayList<ArrayList<String>>> options3Items) {
        ...
        options1Items.add(new ProvinceBean(2, "湖北", "湖南省地处中国中部、长江中游，因大部分区域处于洞庭湖以南而得名湖南", "芒果TV"));
        ...
        ArrayList<ArrayList<String>> options3Items_04 = new ArrayList<ArrayList<String>>();
        ...
        ArrayList<String> options3Items_04_01 = new ArrayList<String>();
        options3Items_04_01.add("好山水");
